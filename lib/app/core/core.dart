...
class Core {
  ...
  static CodeModel deleteFromMemory = CodeModel(id: 10, title: DataManager.deleteFromMemory, model1: '*PASS*MEMORY##', model2: '*PASS*MEMORY##', model3: '*PASS*MEMORY##');
  static CodeModel showMemory = CodeModel(id: 11, title: DataManager.showMemory, model1: '*PASS*MEMORY#', model2: '*PASS*MEMORY#', model3: '*PASS*MEMORY#');
  static CodeModel callPriority = CodeModel(id: 12, title: DataManager.callPriority, model1: '*PASS*30#VAL#', model2: '*PASS*30#VAL#', model3: '*PASS*30#VAL#');
  static CodeModel setZoneSetting = CodeModel(id: 27, title: DataManager.setZoneSetting, model1: '*PASS*49#XY#', model2: '*PASS*49#XY#', model3: '*PASS*49#XY#');
  ...
  static CodeModel alarmOnOffPower = CodeModel(id: 15, title: DataManager.alarmOnOffPower, model1: '*PASS*42#VAL#', model2: '*PASS*42#VAL#', model3: '*PASS*42#VAL#');
  ...
  static CodeModel selectSimType = CodeModel(id: 31, title: DataManager.selectSimType, model1: '*PASS*32#VAL#', model2: '*PASS*32#VAL#', model3: '*PASS*32#VAL#');
  ...
  static CodeModel setupLanguageSMS = CodeModel(id: 20, title: DataManager.setupLanguageSMS, model1: '*PASS*31#VAL#', model2: '*PASS*31#VAL#', model3: '*PASS*31#VAL#');
  ...
  static CodeModel remoteControl = CodeModel(id: 22, title: DataManager.remoteControl, model1: '*PASS*37#VAL#', model2: '*PASS*37#VAL#', model3: '*PASS*37#VAL#');
  static CodeModel setAlarmTime = CodeModel(id: 23, title: DataManager.setAlarmTime, model1: '*PASS*40#VAL#', model2: '*PASS*40#VAL#', model3: '*PASS*40#VAL#');
  static CodeModel singleSirenSetting = CodeModel(id: 24, title: DataManager.singleSirenSetting, model1: '*PASS*41#VAL#', model2: '*PASS*41#VAL#', model3: '*PASS*41#VAL#');
  static CodeModel setArrivalTime = CodeModel(id: 26, title: DataManager.setArrivalTime, model1: '*PASS*39#VAL#', model2: '*PASS*39#VAL#', model3: '*PASS*39#VAL#');
  ...
  static CodeModel typeOfFixedLineDialing = CodeModel(
    id: 26,
    title: DataManager.typeOfFixedLineDialing,
    model1: '*PASS*35#VAL#',
    model2: '*PASS*35#VAL#',
    model3: '*PASS*35#VAL#',
  );
  ...
  static CodeModel singleSirenWhenSemiActivated = CodeModel(
    id: 26,
    title: DataManager.singleSirenWhenSemiActivated,
    model1: '*PASS*45#VAL#',
    model2: '*PASS*45#VAL#',
    model3: '*PASS*45#VAL#',
  );
  static CodeModel output1AsADoorOpener = CodeModel(
    id: 26,
    title: DataManager.output1AsADoorOpener,
    model1: '*PASS*44#VAL#',
    model2: '*PASS*44#VAL#',
    model3: '*PASS*44#VAL#',
  );
  ...
  static CodeModel twoStageShutdown = CodeModel(id: 26, title: DataManager.twoStageShutdown, model1: '*PASS*50#VAL#', model2: '*PASS*50#VAL#', model3: '*PASS*50#VAL#');
  ...
  static CodeModel connectingTheKeypad = CodeModel(id: 26, title: DataManager.connectingTheKeypad, model1: '*PASS*52#VAL#', model2: '*PASS*60#VAL#', model3: '*PASS*60#VAL#');
  static CodeModel rFReceiverActivation = CodeModel(
    id: 26,
    title: DataManager.rFReceiverActivation,
    model1: '*PASS*53#VAL#',
    model2: '*PASS*53#VAL#',
    model3: '*PASS*53#VAL#',
  );
  static CodeModel sendRemainingCharge = CodeModel(id: 26, title: DataManager.sendRemainingCharge, model1: '*PASS*55#VAL#', model2: '*PASS*55#VAL#', model3: '*PASS*55#VAL#');
  static CodeModel simCardModuleActivation = CodeModel(
    id: 26,
    title: DataManager.simCardModuleActivation,
    model1: '*PASS*54#VAL#',
    model2: '*PASS*54#VAL#',
    model3: '*PASS*54#VAL#',
  );
  static CodeModel zone13Masha = CodeModel(id: 26, title: DataManager.zone13Masha, model1: '*PASS*57#VAL#', model2: '*PASS*57#VAL#', model3: '*PASS*57#VAL#');
  static CodeModel doubleProtection = CodeModel(id: 26, title: DataManager.doubleProtection, model1: '*PASS*58#VAL#', model2: '*PASS*59#VAL#', model3: '*PASS*59#VAL#');
  static CodeModel zone14ManualSwitch = CodeModel(id: 26, title: DataManager.zone14ManualSwitch, model1: '*PASS*59#VAL#', model2: '*PASS*59#VAL#', model3: '*PASS*59#VAL#');
  static CodeModel changeDevicePassword = CodeModel(
    id: 26,
    title: DataManager.changeDevicePassword,
  ...
  static CodeModel changingTheVolumeOfTheMainSiren = CodeModel(
    id: 26,
    title: DataManager.changingTheVolumeOfTheMainSiren,
    model1: '*PASS*28#1VAL#',
    model2: '*PASS*28#1VAL#',
    model3: '*PASS*28#1VAL#',
  );
  static CodeModel changingTheVolumeOfSSingleSiren = CodeModel(
    id: 26,
    title: DataManager.changingTheVolumeOfSSingleSiren,
    model1: '*PASS*28#1VAL#',
    model2: '*PASS*28#1VAL#',
    model3: '*PASS*28#1VAL#',
  );
  static CodeModel changeKeypadPassword = CodeModel(
    id: 26,
    title: DataManager.changeKeypadPassword,
    model1: '*PASS*31#NEWPASS#',
    model2: '*PASS*31#NEWPASS#',
    model3: '*PASS*31#NEWPASS#',
  );
  static CodeModel changeOut1ByRemote = CodeModel(id: 26, title: DataManager.changeOut1ByRemote, model1: '*PASS*45#VAL#', model2: '*PASS*45#VAL#', model3: '*PASS*45#VAL#');
  static CodeModel rejectCallFromUnknownNumber = CodeModel(
    id: 26,
    title: DataManager.rejectCallFromUnknownNumber,
    model1: '*PASS*46#VAL#',
    model2: '*PASS*46#VAL#',
    model3: '*PASS*46#VAL#',
  );
  static CodeModel deleteRemote = CodeModel(id: 26, title: DataManager.deleteRemote, model1: '*PASS*47#VAL#', model2: '*PASS*47#VAL#', model3: '*PASS*47#VAL#');
  static CodeModel powerOutageCall = CodeModel(id: 26, title: DataManager.powerOutageCall, model1: '*PASS*52#VAL#', model2: '*PASS*52#VAL#', model3: '*PASS*52#VAL#');
  static CodeModel lowBatteryWarning = CodeModel(id: 26, title: DataManager.lowBatteryWarning, model1: '*PASS*53#VAL#', model2: '*PASS*53#VAL#', model3: '*PASS*53#VAL#');
  static CodeModel instantaneousOutputTimerBasedOn = CodeModel(
    id: 26,
    title: DataManager.instantaneousOutputTimerBasedOn,
    model1: '*PASS*50#VAL#',
    model2: '*PASS*50#VAL#',
    model3: '*PASS*50#VAL#',
  );
  static CodeModel internalBellMessage = CodeModel(id: 26, title: DataManager.internalBellMessage, model1: '*PASS*54#VAL#', model2: '*PASS*54#VAL#', model3: '*PASS*54#VAL#');
  static CodeModel chirpPartSet = CodeModel(id: 26, title: DataManager.chirpPartSet, model1: '*PASS*55#VAL#', model2: '*PASS*55#VAL#', model3: '*PASS*55#VAL#');
  static CodeModel disableSIMCardCalls = CodeModel(id: 26, title: DataManager.disableSIMCardCalls, model1: '*PASS*56#VAL#', model2: '*PASS*56#VAL#', model3: '*PASS*56#VAL#');
  static CodeModel smsFromUnknownNumberCalledMr = CodeModel(
    id: 26,
    title: DataManager.smsFromUnknownNumberCalledMr,
  ...
  static CodeModel silencingASingleZone = CodeModel(
    id: 26,
    title: DataManager.silencingASingleZone,
  ...
  static TbCodeModel tbCodeModel = TbCodeModel(
    ...
    list: [
      ...
      CodeModel(id: 10, title: DataManager.deleteFromMemory, model1: '*PASS*MEMORY##', model2: '*PASS*MEMORY##', model3: '*PASS*MEMORY##'),
      CodeModel(id: 11, title: DataManager.showMemory, model1: '*PASS*MEMORY#', model2: '*PASS*MEMORY#', model3: '*PASS*MEMORY#'),
      CodeModel(
        id: 12,
      ...
      CodeModel(
        id: 16,
        title: DataManager.alarmOnOffConfidental,
        //ارسال گزارش روشن و خاموش شدن دزدگیر
        model1: '*PASS*34#VAL#',
        model2: '*PASS*34#VAL#',
        model3: '*PASS*34#VAL#',
      ),
      ...
      CodeModel(id: 30, title: DataManager.changeZoneName, model1: '*PASS*NUMBER#PARAM#', model2: '*PASS*NUMBER#PARAM#', model3: '*PASS*NUMBER#PARAM#'),
      CodeModel(
        id: 26,
        title: DataManager.typeOfFixedLineDialing,
        //نوع شماره گیری خط ثابت
        model1: '*PASS*35#VAL#',
        model2: '*PASS*35#VAL#',
        model3: '*PASS*35#VAL#',
      ),
      ...
      CodeModel(
        id: 26,
        title: DataManager.twoStageShutdown,
      ...
      CodeModel(
        id: 26,
        title: DataManager.connectingTheKeypad,
        //اتصال کی پد
        model1: '*PASS*52#VAL#',
        model2: '*PASS*60#VAL#',
        model3: '*PASS*60#VAL#',
      ...
      CodeModel(
        id: 26,
        title: DataManager.sendRemainingCharge,
        //ارسال باقیمانده شارژ
        model1: '*PASS*55#VAL#',
        model2: '*PASS*55#VAL#',
        model3: '*PASS*55#VAL#',
      ),
      ...
      CodeModel(
        id: 26,
        title: DataManager.doubleProtection,
        //حفاظت مضاعف
        model1: '*PASS*58#VAL#',
        model2: '*PASS*59#VAL#',
        model3: '*PASS*59#VAL#',
      ...
      CodeModel(
        id: 26,
        title: DataManager.zone14ManualSwitch,
        //سوییچ دستی زون۱۴
        model1: '*PASS*59#VAL#',
        model2: '*PASS*59#VAL#',
        model3: '*PASS*59#VAL#',
      ...
      CodeModel(
        id: 26,
        title: DataManager.changeOut1ByRemote,
        //تغییر out1 توسط ریموت
        model1: '*PASS*45#VAL#',
        model2: '*PASS*45#VAL#',
        model3: '*PASS*45#VAL#',
      ),
      ...
      CodeModel(
        id: 26,
        title: DataManager.deleteRemote,
        //حذف ریموت
        model1: '*PASS*47#VAL#',
        model2: '*PASS*47#VAL#',
        model3: '*PASS*47#VAL#',
      ...
      CodeModel(
        id: 26,
        title: DataManager.powerOutageCall,
        //تماس قطع برق
        model1: '*PASS*52#VAL#',
        model2: '*PASS*52#VAL#',
        model3: '*PASS*52#VAL#',
      ...
      CodeModel(
        id: 26,
        title: DataManager.lowBatteryWarning,
        //هشدار باطری ضعیف
        model1: '*PASS*53#VAL#',
        model2: '*PASS*53#VAL#',
        model3: '*PASS*53#VAL#',
      ...
      CodeModel(
        id: 26,
        title: DataManager.internalBellMessage,
        //پیام زنگ داخلی
        model1: '*PASS*54#VAL#',
        model2: '*PASS*54#VAL#',
        model3: '*PASS*54#VAL#',
      ...
      CodeModel(
        id: 26,
        title: DataManager.chirpPartSet,
        //چریپ پارت ست
        model1: '*PASS*55#VAL#',
        model2: '*PASS*55#VAL#',
        model3: '*PASS*55#VAL#',
      ...
      CodeModel(
        id: 26,
        title: DataManager.disableSIMCardCalls,
